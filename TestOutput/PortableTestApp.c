...
void m_PortableTestApp_Program_Main_0(t_System_String** p_args)
{
	...
	t_PortableTestApp_Program* l_p2_2;
	t_PortableTestApp_MyBaseClass* l_m_3;
	t_PortableTestApp_MyAbstractClass* l_m2_4;
	int32_t* l_a_5;
	int32_t l_aa_i_6;
	t_PortableTestApp_MyBaseClass* l_i_7;
	uint8_t* l_a2_8;
	t_PortableTestApp_MyEnumerablePortableTestApp_MyEnumerable_System_Int32_GENERIC* l_es_9;
	t_PortableTestApp_MyEnumeratorPortableTestApp_MyEnumerator_System_Int32_GENERIC l_e_en_10;
	float* l_sldkfj_11;
	float* l_sldkfj2_12;
	t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC* l_myG_13;
	int32_t l_myGI_14;
	int32_t l_myGI2_15;
	int32_t l_myGI3_16;
	t_PortableTestApp_Vec3 l_myGIS_17;
	...
	if (CS2X_IS_JMP_0 == 0)
	{
		...
		/* using */
		l_p2_2 = m_PortableTestApp_Program__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_Program), &rt_PortableTestApp_Program_OBJ));
		...
		m_PortableTestApp_Program_Dispose_0(l_p2_2);
	...
	m_PortableTestApp_Program_Dispose_0(l_p_1);
	...
	f_PortableTestApp_Program_myDelegate = m_System_Delegate_Combine_0(f_PortableTestApp_Program_myDelegate, m_PortableTestApp_Program_MyDelegate__ctor_0(CS2X_AllocType(sizeof(t_PortableTestApp_Program_MyDelegate), &rt_PortableTestApp_Program_MyDelegate_OBJ), 0, &m_PortableTestApp_Program_MyDelegateCallbackStatic_0));
	if (f_PortableTestApp_Program_myDelegate != 0) m_PortableTestApp_Program_MyDelegate_Invoke_0(f_PortableTestApp_Program_myDelegate, StringLiteral_7);
	f_PortableTestApp_Program_value = StringLiteral_8;
	f_PortableTestApp_Program_myEnum = 0;
	l_m_3 = m_PortableTestApp_MyBaseClass__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_MyBaseClass), &rt_PortableTestApp_MyBaseClass_OBJ));
	m_PortableTestApp_MyBaseClass_MyVirtMethod_0(l_m_3);
	l_m2_4 = (t_PortableTestApp_MyAbstractClass*)l_m_3;
	((rt_PortableTestApp_MyAbstractClass*)l_m2_4->CS2X_RuntimeType)->vTable_MyVirtMethod_0(l_m2_4);
	m_PortableTestApp_MyAbstractClass_MyFoo_0(l_m_3);
	l_a_5 = CS2X_AllocArrayTypeAtomic(sizeof(int32_t), 5, &rt_System_Int32___ARRAY_OBJ);
	((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[0] = 1;
	((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[1] = 2;
	((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[2] = 3;
	((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[3] = 4;
	((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[4] = 5;
	if (m_System_Object_GetType_0(l_a_5) == (&rt_System_Int32___ARRAY_OBJ)) m_System_Console_WriteLine_0(m_System_Object_GetType_0(l_a_5)->f__FullName_k__BackingField_1);
	for (l_aa_i_6 = 0; l_aa_i_6 != m_System_Array_get_Length_0((t_System_Array*)l_a_5); ++l_aa_i_6)
	{
		int32_t l_aa_7;
		l_aa_7 = ((int32_t*)(((char*)l_a_5) + (sizeof(size_t)*2)))[l_aa_i_6];
	...
	l_i_7 = m_PortableTestApp_MyBaseClass__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_MyBaseClass), &rt_PortableTestApp_MyBaseClass_OBJ));
	l_i_7->f_b_2 = 44;
	l_i_7->f_c_2 = 33;
	l_i_7->f_d_2 = 66;
	l_a2_8 = alloca(sizeof(uint8_t) * 3);
	l_a2_8[0] = 1;
	l_a2_8[1] = 2;
	l_a2_8[2] = 3;
	l_es_9 = m_t_PortableTestApp_MyEnumerablePortableTestApp_MyEnumerable_System_Int32_GENERIC__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_MyEnumerablePortableTestApp_MyEnumerable_System_Int32_GENERIC), &rt_PortableTestApp_MyEnumerable_System_Int32_GENERIC_OBJ));
	for/*each*/ (l_e_en_10 = m_t_PortableTestApp_MyEnumerablePortableTestApp_MyEnumerable_System_Int32_GENERIC_GetEnumerator_0(l_es_9); m_t_PortableTestApp_MyEnumeratorPortableTestApp_MyEnumerator_System_Int32_GENERIC_MoveNext_0(&l_e_en_10);)
	{
		int32_t l_e_11;
		l_e_11 = m_t_PortableTestApp_MyEnumeratorPortableTestApp_MyEnumerator_System_Int32_GENERIC_get_Current_0(&l_e_en_10);
		if (l_e_11 == 0) m_System_Console_Write_0(StringLiteral_10);
	}
	l_myG_13 = m_t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC), &rt_PortableTestApp_MyG_System_Int32_GENERIC_OBJ));
	l_myGI_14 = m_t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC_DoStuff_0(l_myG_13);
	l_myGI2_15 = m_t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC_DoStuff2_1(l_myG_13, 123);
	l_myGI3_16 = m_t_PortableTestApp_MyGPortableTestApp_MyG_System_Int32_GENERIC_DoStuff3_1(l_myG_13, 55.0f, 123, 55);
	l_myGIS_17 = m_t_PortableTestApp_MyGPortableTestApp_MyG_PortableTestApp_Vec3_GENERIC_DoStuffStatic_0(1);
	m_System_Console_WriteLine_0(m_System_Object_GetType_0(l_myG_13)->f__FullName_k__BackingField_1);
	/* try */
	memcpy(CS2X_JMP_LAST_0, CS2X_ThreadExceptionJmpBuff, sizeof(jmp_buf));
	CS2X_IS_JMP_0 = setjmp(CS2X_JMP_0);
	if (CS2X_IS_JMP_0 == 0)
	{
		t_PortableTestApp_MyAbstractClass* l_c_18;
		memcpy(CS2X_ThreadExceptionJmpBuff, CS2X_JMP_0, sizeof(jmp_buf));
		l_c_18 = m_PortableTestApp_MyBaseClass__ctor_0(CS2X_AllocTypeAtomic(sizeof(t_PortableTestApp_MyBaseClass), &rt_PortableTestApp_MyBaseClass_OBJ));
		m_PortableTestApp_Program_FooThrow_0((t_PortableTestApp_MyBaseClass*)CS2X_TestUpCast(l_c_18, &rt_PortableTestApp_MyBaseClass_OBJ));
		/* protected return */
		{
			memcpy(CS2X_ThreadExceptionJmpBuff, CS2X_JMP_LAST_0, sizeof(jmp_buf));
			return;
	...
	else /* end try */
	{
		...
		{
			t_System_NotSupportedException* l_e_18;
			l_e_18 = CS2X_ThreadExceptionObject;
			CS2X_ThreadExceptionObject = 0;
			m_System_Console_WriteLine_0(m_System_String_Concat_0(StringLiteral_11, l_e_18->f__Message_k__BackingField_1));
		}
		else if (CS2X_IsType(((t_System_Object*)CS2X_ThreadExceptionObject)->CS2X_RuntimeType, &rt_System_Exception_OBJ)) /* catch */
		{
			t_System_Exception* l_e_18;
			l_e_18 = CS2X_ThreadExceptionObject;
			CS2X_ThreadExceptionObject = 0;
			m_System_Console_WriteLine_0(m_System_String_Concat_0(StringLiteral_12, l_e_18->f__Message_k__BackingField_1));
		}
...
void m_PortableTestApp_Program_FooThrow_0(t_PortableTestApp_MyBaseClass* p_a)
{
	CS2X_ThreadExceptionObject = m_System_NotSupportedException__ctor_0(CS2X_AllocType(sizeof(t_System_NotSupportedException), &rt_System_NotSupportedException_OBJ), StringLiteral_13);
	longjmp(CS2X_ThreadExceptionJmpBuff, 1); /* throw exception */
}
